...
from custom_components.powersensor.sensor import (
...
async def test_powersensor_sensor_default_name(
    ...
    with patch(
        "custom_components.powersensor.sensor.async_dispatcher_connect",
...
async def test_powersensor_sensor_handle_role_update(
    ...
    powersensor_entity_module = importlib.import_module(
        "custom_components.powersensor.sensor"
    )
...
async def test_schedule_unavailable_cancels_existing_timer(
    ...
    monkeypatch.setattr(
        "custom_components.powersensor.sensor.async_call_later",
